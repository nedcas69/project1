...
Jamshid_image = face_recognition.load_image_file("/home/oo7/project1/project1/twty/2.jpg")
Jamshid_face_encoding = face_recognition.face_encodings(Jamshid_image)[0]

# Create arrays of known face encodings and their names
known_face_encodings = [
    Shax_face_encoding,
    Jamshid_face_encoding
]
known_face_names = [
    "Shaxboz",
    "Jamshid"
